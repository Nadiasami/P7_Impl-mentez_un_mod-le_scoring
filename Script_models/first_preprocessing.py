...
def kfold_lightgbm(df, num_folds, stratified = False, debug= False):
    ...
    # Ajoutez ici les noms des colonnes qui doivent être des booléens
    boolean_columns = ['CC_NAME_CONTRACT_STATUS_Active_MIN','CC_NAME_CONTRACT_STATUS_Active_MAX',
    ...
    # Convertir ces colonnes en types booléens
    ...
    for n_fold, (train_idx, valid_idx) in enumerate(folds.split(train_df[feats], train_df['TARGET'])):
        ...
        mlflow.sklearn.log_model(clf, "LGBM_model")
    ...
    feature_importance_df.to_csv('C:/Users/smart asus/P7_données/code_vs_code/analyse_nettoyage_experiences/feature_importance_for_model_optimi_time/feature_importance_df.csv', index=False)
...
def display_importances(feature_importance_df_):
    ...
    plt.tight_layout()
    plt.savefig("C:/Users/smart asus/P7_données/code_vs_code/analyse_nettoyage_experiences/feature_importance_for_model_optimi_time/lgbm_importances01.png")

def main(debug = False):
    
    mlflow.set_experiment("first_iteration")
